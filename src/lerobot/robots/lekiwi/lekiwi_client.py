...
class LeKiwiClient(Robot):
    ...
    def send_action(self, action: RobotAction) -> RobotAction:
        ...
        # Action values may be torch tensors (replayed from a dataset) or numpy scalars
        # (from a policy during eval); json.dumps only serializes Python primitives, so
        # coerce each value to a plain float before sending.
